  ...
  try {
    ...
    return {
      ...
      bottlenecks: [
        ...
        { number: 1038, title: "Fix N+1 query in metrics", authorId: "charlie", waitTimeHours: 36 },
        { number: 1051, title: "Add rate limiting middleware", authorId: "diana", waitTimeHours: 18 },
      ]
    }
  }
}
